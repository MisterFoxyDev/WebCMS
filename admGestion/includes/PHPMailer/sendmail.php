...
$mail->Body = 'Bienvenue ! Afin de valider votre inscription, merci de cliquer sur le lien suivant : <a href="localhost/webcms/verification.php?token=' . $token . '&email=' . $_POST['email'] . '">Confirmation</a>';
