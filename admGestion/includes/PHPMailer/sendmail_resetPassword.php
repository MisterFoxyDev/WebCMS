...
$mail->Body = 'Bonjour ! Afin de réinitialiser votre mot de passe, merci de cliquer sur le lien suivant : <a href="localhost/webcms/admGestion/new_password.php?token=' . $token . '&email=' . $_POST['email'] . '">Réinitialisation</a>';
